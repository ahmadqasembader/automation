...
| llm-d | - | - | forming | - | - | - | - | - |
| NMstate | - | - | forming | sandbox | sandbox | sandbox | sandbox | - |
...
| Project | [PCC Slug](./pcc_projects.yaml) | [Landscape Slug](https://github.com/cncf/landscape/blob/master/landscape.yml) | [PCC](./pcc_projects.yaml) | [Landscape](https://github.com/cncf/landscape/blob/master/landscape.yml) | [CLOMonitor](https://github.com/cncf/clomonitor/blob/main/data/cncf.yaml) | [Maintainers](https://github.com/cncf/foundation/blob/main/project-maintainers.csv) | [DevStats](https://devstats.cncf.io/) | [Artwork](https://raw.githubusercontent.com/cncf/artwork/main/README.md) |
|---|---|---|---|---|---|---|---|---|
| Argo | argo | argo | graduated | graduated | graduated | graduated | graduated | graduated |
| cert-manager | cert-manager | cert-manager | graduated | graduated | graduated | graduated | graduated | graduated |
| Cilium | cilium | cilium | graduated | graduated | graduated | graduated | graduated | graduated |
| CloudEvents | cloudevents | cloudevents | graduated | graduated | graduated | graduated | graduated | graduated |
| Containerd | containerd | containerd | graduated | graduated | graduated | graduated | graduated | graduated |
| CoreDNS | coredns | coredns | graduated | graduated | graduated | graduated | graduated | graduated |
| CRI-O | cri-o | cri-o | graduated | graduated | graduated | graduated | graduated | graduated |
| Crossplane | crossplane | crossplane | graduated | graduated | graduated | graduated | graduated | graduated |
| CubeFS | chubaofs | chubaofs | graduated | graduated | graduated | graduated | graduated | graduated |
...
| Harbor | harbor | harbor | graduated | graduated | graduated | graduated | graduated | graduated |
| Helm | helm | helm | graduated | graduated | graduated | graduated | graduated | graduated |
...
| Kubernetes | k8s | k8s | graduated | graduated | graduated | graduated | graduated | graduated |
...
| SPIRE | spire | spire | graduated | graduated | graduated | graduated | graduated | graduated |
| The Update Framework (TUF) | tuf | tuf | graduated | graduated | graduated | graduated | graduated | graduated |
| TiKV | tikv | tikv | graduated | graduated | graduated | graduated | graduated | graduated |
| Vitess | vitess | vitess | graduated | graduated | graduated | graduated | graduated | graduated |

## Incubating

| Project | [PCC Slug](./pcc_projects.yaml) | [Landscape Slug](https://github.com/cncf/landscape/blob/master/landscape.yml) | [PCC](./pcc_projects.yaml) | [Landscape](https://github.com/cncf/landscape/blob/master/landscape.yml) | [CLOMonitor](https://github.com/cncf/clomonitor/blob/main/data/cncf.yaml) | [Maintainers](https://github.com/cncf/foundation/blob/main/project-maintainers.csv) | [DevStats](https://devstats.cncf.io/) | [Artwork](https://raw.githubusercontent.com/cncf/artwork/main/README.md) |
|---|---|---|---|---|---|---|---|---|
| Artifact Hub | artifact-hub | artifact-hub | incubating | incubating | incubating | incubating | incubating | incubating |
| Backstage | backstage | backstage | incubating | incubating | incubating | incubating | incubating | incubating |
| Buildpacks | buildpacks | buildpacks | incubating | incubating | incubating | incubating | incubating | incubating |
...
| Flatcar | flatcar | flatcar | incubating | incubating | incubating | incubating | incubating | incubating |
| Fluid Project | fluid | - | incubating | incubating | incubating | incubating | incubating | incubating |
...
| Kubeflow | kubeflow | kubeflow | incubating | incubating | incubating | incubating | incubating | incubating |
| Kubescape | kubescape | kubescape | incubating | incubating | incubating | incubating | incubating | incubating |
| KubeVela | kubevela | kubevela | incubating | incubating | incubating | incubating | incubating | incubating |
| KubeVirt | kubevirt | kubevirt | incubating | incubating | incubating | incubating | incubating | incubating |
...
| Notary | notary | - | incubating | incubating | incubating | incubating | incubating | incubating |
...
| Bank-Vaults | bank-vaults | bank-vaults | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| BFE | BFE | BFE | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| bootc | bootc | bootc | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| bpfman | bpfman | bpfman | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Cadence | cadence | cadence | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Capsule | capsule | capsule | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Carina | carina | carina | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
...
| container2wasm | container2wasm | container2wasm | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| ContainerSSH | containerssh | containerssh | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Copa | copacetic | copacetic | sandbox | sandbox | sandbox | sandbox | sandbox | - |
| Cozystack | cozystack | cozystack | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Dalec | dalec | dalec | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Devfile | devfile | devfile | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| DevSpace | devspace | devspace | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Dex | dex | dex | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Distribution | cncf-distribution | cncf-distribution | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Drasi | drasi | drasi | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| easegress | easegress | easegress | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Eraser | eraser | eraser | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
...
| Inclavare Containers | inclavarecontainers | inclavarecontainers | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Inspektor Gadget | inspektorgadget | inspektorgadget | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| interLink | interlink | interlink | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| k0s | k0s | k0s | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| k3s | k3s | k3s | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| k8gb | k8gb | k8gb | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
...
| kcp | kcp | kcp | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Kepler | kepler | kepler | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Keylime | keylime | keylime | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| kgateway | kgateway | kgateway | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| KitOps | kitops | kitops | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| ko | ko | ko | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Konveyor | konveyor | konveyor | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Koordinator | koordinator | koordinator | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| kpt | kpt | kpt | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| krkn | krkn | krkn | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Kuadrant | kuadrant | kuadrant | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Kuasar | kuasar | kuasar | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| kube-burner | kube-burner | kube-burner | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Kube-OVN | kube-ovn | kube-ovn | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| kube-rs | kube-rs | kube-rs | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| kube-vip | kube-vip | kube-vip | sandbox | sandbox | sandbox | sandbox | sandbox | - |
...
| KubeSlice | kubeslice | kubeslice | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| KubeStellar | kubestellar | kubestellar | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| kubewarden | kubewarden | kubewarden | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| KUDO | kudo | kudo | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
...
| OpenEverest | openeverest | openeverest | sandbox | sandbox | sandbox | sandbox | sandbox | - |
| OpenFunction | openfunction | openfunction | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| openGemini | opengemini | opengemini | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| OpenGitOps | gitops-wg | gitops-wg | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| OpenTofu | opentf | opentf | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| ORAS (OCI Registry as Storage) | oras | oras | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| OVN-Kubernetes | ovn-kubernetes | ovn-kubernetes | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Oxia | oxia | oxia | sandbox | sandbox | sandbox | sandbox | sandbox | - |
| Paralus | paralus | paralus | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| PARSEC | parsec | parsec | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Perses | perses | perses | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| PipeCD | pipecd | pipecd | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Piraeus-Datastore | piraeus-datastore | piraeus-datastore | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Pixie | pixie | pixie | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Podman Container Tools | podman-container-tools | podman-container-tools | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Podman Desktop | podman-desktop | podman-desktop | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Porter | porter | porter | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Radius | radius | radius | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Ratify | ratify | ratify | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Runme Notebooks | runme-notebooks | runme-notebooks | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| SchemaHero | schemahero | schemahero | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Score | score | score | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Serverless Devs | serverlessdevs | serverlessdevs | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Serverless Workflow Specification | serverlessworkflow | serverlessworkflow | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Service Mesh Performance | service-mesh-performance | service-mesh-performance | sandbox | archived | - | - | - | archived |
| Shipwright | shipwright | shipwright | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| SlimFaaS | slimfaas | slimfaas | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| SlimToolkit | slimtoolkit | slimtoolkit | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| SOPS | sops | sops | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Spiderpool | spiderpool | spiderpool | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Spin | spin | spin | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| stacker | stacker | stacker | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Submariner | submariner | submariner | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Telepresence | telepresence | telepresence | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Tinkerbell | tinkerbell | tinkerbell | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Tokenetes | tratteria | tratteria | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Tremor | tremor | tremor | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| TrestleGRC | trestlegrc | trestlegrc | sandbox | sandbox | - | - | sandbox | - |
...
| werf | werf | werf | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| xRegistry | xregistry | xregistry | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| Youki | youki | - | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
| zot | zot | zot | sandbox | sandbox | sandbox | sandbox | sandbox | sandbox |
